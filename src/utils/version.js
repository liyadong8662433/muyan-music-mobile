...
const address = [
  ...
  ['https://registry.npmjs.org/muyan-music-mobile-version-info/latest', 'npm'],
  ...
  ['https://registry.npmmirror.com/muyan-music-mobile-version-info/latest', 'npm'],
  ['https://gitee.com/lyswhut/muyan-music-mobile-versions/raw/master/version.json', 'direct'],
  ['http://cdn.stsky.cn/muyan-music/mobile/version.json', 'direct'],
]
...
export const downloadNewVersion = async(version, onDownload = noop) => {
  ...
  let savePath = temporaryDirectoryPath + '/muyan-music-mobile.apk'
